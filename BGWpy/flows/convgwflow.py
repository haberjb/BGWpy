"""Workflow to converge a GW calculation."""
...
class convGWFlow(Workflow):
    """
    Converges a GW calcualtion in the spirit of Brad Malone's work:
        - Computes DFT starting point
        - Converges dielectric marix w/r to bands and epscut
        - Converge self-energy w/r to bands
    """
    ...
    def __init__(self, **kwargs):
        ...
        super(convGWFlow, self).__init__(**kwargs)

        kwargs.pop('dirname', None)
        kwargs.pop('ecuteps', None)
        ...
        # Abinit flavor
            ...
            raise Exception('convGW only implemented for QE')
